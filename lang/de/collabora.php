...
$string['height'] = 'Höhe (0 für automatisch)';
$string['initialfile'] = 'Ausgangsdatei';
$string['initialtext'] = 'Ausgangstext';
$string['locked'] = 'Dokument von Lehrkraft gesperrt';
$string['lockedunlock'] = 'Das Dokument ist derzeit gesperrt. Klicken Sie hier, um die Sperre aufzuheben.';
$string['modulename'] = 'Kollaboratives Dokument';
$string['modulename_help'] = 'With this application you can connect to a Collabora Online Server to create a test, word, presentation or spreet sheet document and work with this app.';
$string['modulenameplural'] = 'Kollaborative Dokumente';
$string['name'] = 'Name';
$string['new'] = 'Neue Registrierkarte';
$string['nogroupaccess'] = 'Diese Aktivität steht nur Benutzern zur Verfügung, die Mitglieder einer Kursgruppe sind';
...
$string['requiredfortext'] = 'Erforderlich, wenn das Format \'Specified text\' ist';
$string['requiredforupload'] = 'Erforderlich, wenn das Format \'File upload\' ist';
$string['spreadsheet'] = 'Tabellen-Dokument';
$string['text'] = 'Spezifischer Text';
$string['unsupportedtype'] = 'Nicht unterstützter Dateityp {$a}';
$string['upload'] = 'Datei hochladen';
$string['unlockedlock'] = 'Dokument ist derzeit nicht gesperrt. Klicken Sie hier, um es zu sperren und die Bearbeitung zu verhindern.';
$string['width'] = 'Breite (0 für automatisch)';
$string['wordprocessor'] = 'Word-Dokument';
